...
// NOTE: RegisterState template implementation is in the header file
// (StateManager.hpp) because template methods must be defined in headers for
// proper instantiation. The template includes a static_assert to ensure type
